...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  100d22:	c7 04 24 c4 35 10 00 	movl   $0x1035c4,(%esp)
  ...
  100d3b:	e8 9f f5 ff ff       	call   1002df <vcprintf>
    cprintf("\n");
  100d40:	c7 04 24 c2 35 10 00 	movl   $0x1035c2,(%esp)
...
outb(uint16_t port, uint8_t data) {
  ...
  100da1:	c7 04 24 e2 35 10 00 	movl   $0x1035e2,(%esp)
...
inb(uint16_t port) {
  ...
  101512:	75 1f                	jne    101533 <kbd_proc_data+0x184>
        cprintf("Rebooting!\n");
  101514:	c7 04 24 fd 35 10 00 	movl   $0x1035fd,(%esp)
...
cons_init(void) {
  ...
  101583:	c7 04 24 09 36 10 00 	movl   $0x103609,(%esp)
